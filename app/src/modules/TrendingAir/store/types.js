...
export default {
  CURRENT_SELECTED_LOCATION: 'CURRENT_SELECTED_LOCATION',
  NEW_UPDATED_LOCATION: 'NEW_UPDATED_LOCATION',
  CURRENT_SELECTED_LOCATION_INFORMATION: 'CURRENT_SELECTED_LOCATION_INFORMATION',
};
