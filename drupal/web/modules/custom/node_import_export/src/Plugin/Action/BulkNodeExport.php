...
namespace Drupal\node_import_export\Plugin\Action;
 ...
 *
 * @Action(
 *   id = "bulk_node_import_export",
 *   label = "Node Import-Export",
 *   type = "node",
 *   confirm_form_route_name = "node_import_export.bulk_export_form"
 * )
 */
class BulkNodeExport extends ActionBase implements ContainerFactoryPluginInterface {
  ...
  public function executeMultiple(array $entities) {
    ...
    $this->tempStoreFactory->get('node_import_export_ids')
