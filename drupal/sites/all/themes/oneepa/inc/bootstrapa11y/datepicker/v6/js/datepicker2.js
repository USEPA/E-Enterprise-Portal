...
var datePickerControllerEs = (function datePickerController() {

    var debug = false,
        urlLocal = $(".es_MX-test").attr("lang"),
    ...
    datePicker.prototype.createButton = function() {
        ...
        but.href = "#" + this.id;
        but.className = "date-picker-control btn btn-default";
        ...
        fontIconHolder.innerHTML = '<span class="adobeBlank">Calendario icon</span>';
        ...
        if (this.positioned && document.getElementById(this.positioned)) {
            document.getElementById(this.positioned).appendChild(wrap);
        } else {
    ...
    var localeDefaults = {
        //changed to reflect spanish months, days and other terms for date picker. If english is required, just look at datepicker.js
        ...
        dayAbbrs: ["lun", "mar", "mie", "jue", "vie", "sab", "dom"],
        titles: ["Mes anterior", "Mes próximo", "Año anterior", "El Año que viene", "Hoy", "Mostrar el calendario de", "wk", "Semana [[%0%]] de [[%1%]]", "Semana", "Seleccione una fecha", "Haga clic \u0026 arrastre para mover", "Mostrará \u201C[[%0%]]\u201D primero", "Ir a la fecha de hoy", "Fecha discapacitados :", "Abrir el calendario para [[%0%]]"],
        rtl: false,
        firstDayOfWeek: 0,
        imported: false
    };
