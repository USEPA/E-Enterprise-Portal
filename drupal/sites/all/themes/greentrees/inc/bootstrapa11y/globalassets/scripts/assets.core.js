    ...
    expandCollapse: function(options) {
        ...
        if (options['text'] === true) {
            ...
            if (options['expandDefault'] === true) {
                $('.collapsible-heading-toggle-icon').attr('href', 'javascript:void(0);').attr('aria-expanded', 'true');
                ...
                $('.collapsible-heading-toggle-icon').attr('href', 'javascript:void(0);').attr('aria-expanded', 'false');
                if (!$('.collapsible-heading-toggle-icon').children().hasClass('expand-icon')) {
...
$.widget("ui.dialog", $.ui.dialog, {
    ...
    _createWrapper: function() {
        ...
        this._delay(function() {
            ...
            lowerButtonContainerButton.removeAttr('aria-pressed role');
            headingClosingButton.removeAttr('aria-pressed role');
