...
if(!empty($view->result[$view->row_index]->field_field_todo_lst_part_code)) {
    ...
    print "<div id='modal-page-details-" . $unique_id . "' class='modal-content-in-page'>
             ...
             <b>Sub-part Code:</b> ".$view->result[$view->row_index]->field_field_todo_lst_sub_part_code[0]['rendered']['#markup']."<br>
             <b>Sub-part Name:</b> ".$view->result[$view->row_index]->field_field_todo_lst_sub_part_name[0]['rendered']['#markup']."<br>
