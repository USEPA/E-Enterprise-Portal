 ...
 */
function eenterprise_form_system_theme_settings_alter(&$form, $form_state, $form_id = NULL) {
  ...
  $form['logo']['settings']['eenterprise_logoless'] = array(
    '#type'          => 'checkbox',
  ...
  $form['breadcrumb']['eenterprise_breadcrumb'] = array(
    '#type'          => 'select',
    '#title'         => t('Display breadcrumb'),
    '#default_value' => theme_get_setting('eenterprise_breadcrumb'),
    '#options'       => array(
                          'yes'   => t('Yes'),
  ...
  $form['breadcrumb']['breadcrumb_options'] = array(
    ...
    '#states' => array(
      'invisible' => array(
        ':input[name="eenterprise_breadcrumb"]' => array('value' => 'no'),
      ),
    ),
  );
  $form['breadcrumb']['breadcrumb_options']['eenterprise_breadcrumb_separator'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Breadcrumb separator'),
    '#description'   => t('Text only. Don’t forget to include spaces.'),
    '#default_value' => theme_get_setting('eenterprise_breadcrumb_separator'),
    '#size'          => 5,
    '#maxlength'     => 10,
  );
  $form['breadcrumb']['breadcrumb_options']['eenterprise_breadcrumb_home'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Show home page link in breadcrumb'),
    '#default_value' => theme_get_setting('eenterprise_breadcrumb_home'),
  );
  $form['breadcrumb']['breadcrumb_options']['eenterprise_breadcrumb_trailing'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Append a separator to the end of the breadcrumb'),
    '#default_value' => theme_get_setting('eenterprise_breadcrumb_trailing'),
    '#description'   => t('Useful when the breadcrumb is placed just before the title.'),
    '#states' => array(
      'disabled' => array(
        ':input[name="eenterprise_breadcrumb_title"]' => array('checked' => TRUE),
      ),
    ),
  );
  $form['breadcrumb']['breadcrumb_options']['eenterprise_breadcrumb_title'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Append the content title to the end of the breadcrumb'),
    '#default_value' => theme_get_setting('eenterprise_breadcrumb_title'),
  ...
  // Only toggle the layout for the main eenterprise theme.
  if ($form['var']['#value'] == 'theme_eenterprise_settings') {
    $form['support']['eenterprise_layout'] = array(
      '#type'          => 'radios',
      '#title'         => t('Layout'),
      '#options'       => array(
        'eenterprise-responsive-sidebars' => t('Responsive sidebar layout') . ' <small>(layouts/responsive-sidebars.css)</small>',
        'eenterprise-fixed-width' => t('Fixed width layout') . ' <small>(layouts/fixed-width.css)</small>',
      ),
      '#default_value' => theme_get_setting('eenterprise_layout'),
    );
  }
  $form['support']['eenterprise_skip_link_anchor'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Anchor ID for the “skip link”'),
    '#default_value' => theme_get_setting('eenterprise_skip_link_anchor'),
    '#field_prefix'  => '#',
  ...
  $form['support']['eenterprise_skip_link_text'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Text for the “skip link”'),
    '#default_value' => theme_get_setting('eenterprise_skip_link_text'),
    '#description'   => t('For example: <em>Jump to navigation</em>, <em>Skip to content</em>'),
  );
  $form['support']['eenterprise_html5_respond_meta'] = array(
    '#type'          => 'checkboxes',
    '#title'         => t('Add HTML5 and responsive scripts and meta tags to every page.'),
    '#default_value' => theme_get_setting('eenterprise_html5_respond_meta'),
    '#options'       => array(
  ...
  $form['themedev']['eenterprise_rebuild_registry'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Rebuild theme registry on every page.'),
    '#default_value' => theme_get_setting('eenterprise_rebuild_registry'),
  ...
  $form['themedev']['eenterprise_wireframes'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Add wireframes around main layout elements'),
    '#default_value' => theme_get_setting('eenterprise_wireframes'),
