...
<div id="first-time-user-profile" tabindex="-1">
  ...
  <div class="first-time-second-page" style="display:none">
    <div id="local-gov-topics">
      ...
      <p id="topic-description">Select a few high-level topics that interest you. <span class="sr-only">Use the space bar to select topics.</span>
      </p>
