...
<div id="local-resources-tabs" class="view-content">
  ...
  <div id="all-local-resources-wrapper" class="all local resources wrapper clearfix">
    <div class="faceted-filters on left">
      <div class="toggle">
        Adjust selections
        <img src="<?php print drupal_get_path('module', 'recommended_resources'); ?>/images/chevron-left.png" class="favorites-ignore icon" alt="Click to collapse" />
      </div>
      <h3>
        <span class="icon on">
    ...
    <div class="left">
      <div class="clearfix">
        <div class="faceted-filters off left">
          <div class="toggle">
            Adjust selections
            <img src="<?php print drupal_get_path('module', 'recommended_resources'); ?>/images/chevron-right.png" class="favorites-ignore icon" alt="Click to expand" />
          </div>
        </div>
