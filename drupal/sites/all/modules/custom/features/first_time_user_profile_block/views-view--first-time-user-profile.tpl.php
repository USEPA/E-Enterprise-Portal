...
have a few questions below. You can adjust these later in 'My account' too.</p>
    ...
    <p id="location-description-intro">Pick a location to see environmental information for that area. For now, we've set a placeholder location of Durham, <abbr title="North Carolina">NC</abbr>.</p>
    ...
    <div id="location-add-new">
        <span style="display:none" id="new-location">
                <label for="new-location-input">Enter city, state or ZIP code</label> <input id="new-location-input"/>
                <button class="btn btn-primary btn-sm" id="add-location">Save</button>
        </span>
        <span style="display:none" id="choose-zip-holder">
            <label for=""> Select your ZIP code</label><span id="choose-zip"></span>
			<button class="btn btn-default btn-sm" id="confirm-zip-select">Confirm</button>
        </span>
        <button style="display: none" class="btn btn-danger btn-sm" id="cancel-zip-select">Cancel</button>
