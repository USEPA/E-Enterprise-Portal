(function($) {
  ...
  $(document).ready(function() {
    ...
    $select.change(function() {
      ...
      if (currentZip != 'view_more') {
        ...
        console.log("Update map with zip: ", currentZip);
      }
    });
  ...
  function setiFrameNewURL(zipCentLat, zipCentLon) {
    var iFrameURL = "http://www.epa.gov/myenvmap/mainmap.html?mW=490&mH=490&pTheme=all&embed=true&mode=r&pQuery=&pLayers=afs,triair,pcs,triwater,npl,rcra,triland,energycoal,tsca&ve=11," + zipCentLat + "," + zipCentLon;
