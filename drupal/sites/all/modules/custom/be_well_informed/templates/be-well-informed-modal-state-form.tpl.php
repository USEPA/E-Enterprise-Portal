  ...
  <div id="bwi-tabs">
    ...
    <div id="entry-results">
      ...
      <!--<div id="be-well-informed-results-wrapper"
           class="be-well-informed-modal-wrapper"><h3>Your Water Analysis Results</h3>
                  ...
                  <div class="step-class">
                    <?php /*foreach ($treatments as $t): */?>
                        <div class="clearfix treatment-step hide">
                            <div class="caret"></div>
                            <div class="step">
                                <span class='<?php /*if ($t['icon']): echo "treatment-icon {$t['icon']}-icon step-icon "; endif; */?>fill-step'></span>
                            </div>
