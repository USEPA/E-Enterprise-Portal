...
<div class="<?php print $classes; ?>">
  ...
  <div class="view-content" id="interactive-maps-actions">
    <div id="numThumbnails" class="widget-note favorites-ignore">
      <p class="widget-note"><span id="map-count">Loading </span> maps - <a
          href="https://epa.maps.arcgis.com/home/search.html?q=&t=content&focus=applications" target="_blank"
          class="favorites-ignore">Browse US EPA gallery...</a></p>
    </div>
    <div id="myMapsFiltering">
      <ul id="myMapsFilterList">
        <li id="myMapsFilterAll"><a href="#interactive-maps-carousel" id="mapsAll"
                                    class="myMapFilterTerm favorites-ignore"><span
              class="sr-only">Show </span>All</a><span class="sr-only"> maps</span></li>
        <li id="myMapsFilterAir"><a href="#interactive-maps-carousel" id="mapsAir"
                                    class="myMapFilterTerm favorites-ignore"><span
              class="sr-only">Show </span>Air</a><span class="sr-only"> maps only</span></li>
        <li id="myMapsFilterWater"><a href="#interactive-maps-carousel" id="mapsWater"
                                      class="myMapFilterTerm favorites-ignore"><span
              class="sr-only">Show </span>Water<span class="sr-only"> maps only</span></a></li>
        <li id="myMapsFilterLand"><a href="#interactive-maps-carousel" id="mapsLand"
                                     class="myMapFilterTerm favorites-ignore"><span
              class="sr-only">Show </span>Land<span class="sr-only"> maps only</span></a></li>
      </ul>
