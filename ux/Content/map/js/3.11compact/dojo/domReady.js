...
//>>built
define("dojo/domReady",["./has"],function(s){function d(b){c.push(b);e&&p()}function p(){if(!k){for(k=!0;c.length;)try{c.shift()(a)}catch(b){console.log("Error on domReady callback: "+b)}k=!1;d._onQEmpty()}}var l=function(){return this}(),a=document,m={loaded:1,complete:1},n="string"!=typeof a.readyState,e=!!m[a.readyState],c=[],k;d.load=function(b,a,c){d(c)};d._Q=c;d._onQEmpty=function(){};n&&(a.readyState="loading");if(!e){var f=[],g=function(b){b=b||l.event;e||"readystatechange"==b.type&&!m[a.readyState]||
